            ...
            <div>
                <div style="display: flex;justify-content: center">
                    <el-upload
                            ...
                            :data="hr"
                           >
                        <img style=" width: 118px;height: 99px" src="../../public/jingyi.jpg">
                    </el-upload>
                </div>
                <div>电话号码：
...
<script>
    export default {
        ...
        methods: {
            ...
            updateHrInfo() {
                this.putRequest("/apis/hr/info", this.hr2).then(resp => {
                    if (resp) {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.putRequest("/apis/hr/pass", this.ruleForm).then(resp => {
                            if (resp) {
            ...
            initHr() {
                this.getRequest('/apis/user/info').then(resp => {
                    if (resp) {
                        this.hr = resp;
