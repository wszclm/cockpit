            ...
            <div class='marketing-content'>
                <el-row :gutter='10'>
                    <el-col :span='24' align='right'>
                        <el-button type='success' icon='el-icon-download'> <a style="color:#fff" href="../static/file/核心指标监测.xls" download="核心指标监测.xls">核心指标监测模板下载</a></el-button>
                        <el-button type='primary' icon='el-icon-delete-solid' @click='batchRemove'>删除</el-button>
                          </el-col>
                          <el-col>
                           <el-upload
                                    ref="upload"
                                    action='/apis/targetMonitor/batchImport' 
...
export default {
    ...
    methods: {
        ...
        getTableData() {
            ...
            this.getRequest('/targetMonitor/queryAll').then(resp => {
                this.loading = false;
                if (resp) {
