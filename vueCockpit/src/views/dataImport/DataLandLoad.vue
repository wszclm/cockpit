<template>
    <el-dialog title="国土数据导入" top='1%' :visible.sync="isShow"  size="large" class='min-body queryOffer edit-dialog' lock-scroll :modal='true'>
                    <el-form :model="form">
    ...
    methods: {
         submitUpload() {
            ...
            uploadOk(val){
                ...
                this.postMultRequest(this.$CST.LOAD_LAND_IMPORT, fd).then(resp => {
                this.loading = false;
                if (resp) {
