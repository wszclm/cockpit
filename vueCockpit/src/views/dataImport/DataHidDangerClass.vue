            ...
            <div class='marketing-content'>
                <el-row :gutter='10'>
                    <el-col :span='24' align='right'>
                        <el-button type='success' icon='el-icon-download'> <a style="color:#fff" href="../static/file/数据分析-隐患分类分析.xls" download="数据分析-隐患分类分析xls">隐患分类分析模板下载</a></el-button>
                ...
                <el-row :gutter='10' style='margin-top: 1%;'>
                    <el-col :span='24' >
                        <el-table ref="table" :data='tableData' :border=true :stripe=true v-loading='loading' @selection-change="changeFun" element-loading-text='拼命加载中'>
                            ...
                            <el-table-column prop='hidDangerType' align='center' label='隐患类型' ></el-table-column>
    ...
    methods: {
        ...
        batchRemove(){
            this.$confirm('此操作将永久删除选中的数据, 是否继续?', '提示', {
                ...
                this.deleteRequest('/hidDangerClass/deleteById',{ids:ids}).then(resp => {
        ...
        getTableData() {
            ...
            this.getRequest('/hidDangerClass/queryAll').then(resp => {
                this.loading = false;
                if (resp) {
