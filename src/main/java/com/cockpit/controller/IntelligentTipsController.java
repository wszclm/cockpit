...
import com.cockpit.service.impl.IntelligentTipsServiceImpl;
...
@Api(value = "智能预警数据导入", tags = {"HiddenDangerController"},description ="智能预警数据导入")
@RestController
public class IntelligentTipsController {
    ...
    @ApiOperation(value = "智能预警数据导入", notes = "智能预警数据导入")
    @RequestMapping(value = "/intelligentTips/batchImport", method = RequestMethod.POST)
    public RestResult batchQueryInstType(@RequestParam("file") MultipartFile file, Model model, HttpServletRequest req ) {
        ...
        try {
            ...
            if (str.toUpperCase().equals("XLS") || str.toUpperCase().equals("XLSX")) {
                ...
                intelligentTipsService.batchImport(reList);
    ...
    @ApiModel
    static class IntelligentTipsVo implements Serializable {
    ...
    // 安全隐患数据查询
    @ApiOperation(value = "智能预警数据查询", notes = "智能预警数据查询")
    @RequestMapping(value = "/intelligentTips/queryAll", method = RequestMethod.GET)
    public RestResult queryEnterpriseData( HttpServletRequest request,IntelligentTipsVo intelligentTipsVo) {
        RestResult result = new RestResult();
        List<Map<String, Object>> resultList = new ArrayList<Map<String, Object>>();
        try {
            HashMap<Object, Object> map = new HashMap<>();
            map.put("startDate",intelligentTipsVo.getStartDate());
            map.put("endDate",intelligentTipsVo.getEndDate());
            Map<String,Object> results =  intelligentTipsService.queryIntelligentTips(map);
    ...
    // 安全隐患数据删除
    @ApiOperation(value = "智能预警数据删除", notes = "智能预警数据删除")
    @RequestMapping(value = "/intelligentTips/deleteById", method = RequestMethod.DELETE)
    public RestResult deleteEnterpriseData( HttpServletRequest request, @RequestBody IntelligentTipsVo intelligentTipsVo) {
        RestResult result = new RestResult();
        List<Map<String, Object>> resultList = new ArrayList<Map<String, Object>>();
        try {
            intelligentTipsService.deleteIntelligentTips(intelligentTipsVo.getIds());
            result.setMeta(HttpStatus.OK.value(),"删除成功");
        } catch (BaseException e) {
            logger.debug("智能预警数据删除异常：{}", e.getMessage());
            result.setInfo(resultList);
